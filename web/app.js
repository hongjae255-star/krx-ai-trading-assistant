...
function activeData(d){
  if(currentMarket==='US') return {recs:d.us?.recommendations||[], learning:d.us?.learning||{}, interval:d.us?.monitor_interval_minutes||10, reports:{report_count:0,broker_count:0,top:[]}, currency:'USD'};
  return {recs:d.recommendations||[], learning:d.learning||{}, interval:d.monitor_interval_minutes||10, reports:d.reports||{}, currency:'KRW'};
}
