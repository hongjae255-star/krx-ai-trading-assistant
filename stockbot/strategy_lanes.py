    ...
    def day_lane(self, candidates: list[Candidate], daily_map: dict[str, pd.DataFrame], market: str) -> dict[str, Any]:
        ...
        for c in candidates:
            ...
            rows.append({
                ...
                "method": "liquidity + demand + short momentum + VWAP/market + volatility reachability",
    ...
    def swing_lane(
        ...
        for c in shortlist:
            ...
            rows.append({
                ...
                "institutional": inst,
                "method": "Stage-2 + momentum/RS + 52-week high + demand + CAN-SLIM-inspired + regime + 13F context",
