...
def main(argv=None):
    ...
    p_price.add_argument("--head", type=int, help="Show first N rows")
    p_price.add_argument("--tail", type=int, help="Show last N rows")
    ...
    p_snap.add_argument("--head", type=int, help="Show first N rows")
    p_snap.add_argument("--tail", type=int, help="Show last N rows")
    ...
    p_listing.add_argument("--head", type=int, help="Show first N rows")
    p_listing.add_argument("--tail", type=int, help="Show last N rows")
