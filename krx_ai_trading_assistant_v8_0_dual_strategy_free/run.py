...
def main() -> int:
    ...
    parser.add_argument("command", choices=["doctor", "research", "premarket", "intraday", "close", "status", "validate-model", "macro", "us-premarket", "us-intraday", "us-close", "us-status", "scheduler", "web", "app", "cloud-init", "cloud-deploy", "history"])
    ...
    if args.command == "history":
        from stockbot.historical_v9 import cli as history_cli
        return history_cli(settings.root, extra)
