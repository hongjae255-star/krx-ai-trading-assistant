...
class DashboardStore:
    ...
    def learning_summary(self) -> dict:
        ...
        learning_state = self.db.get_state("last_learning_summary", {}) or {}
        latest_metrics = {}
        if latest:
            try: latest_metrics = json.loads(dict(latest).get("metrics_json") or "{}")
            except Exception: latest_metrics = {}
        return {
            "samples": len(recent),
            ...
            "last_learning": learning_state,
            "shadow_samples": int(latest_metrics.get("shadow_samples", 0) or 0),
            "today_shadow_samples": int(latest_metrics.get("today_shadow_samples", 0) or 0),
            "lessons": learning_state.get("lessons", []),
        }
    ...
    def dashboard(self) -> dict:
        ...
        return {
            ...
            "strategy_lanes": self.db.get_state("strategy_lanes_latest", {}) or {},
            "reports": reports,
            "learning": learning,
            ...
            "us": {
                ...
                "strategy_lanes": self.us_db.get_state("us_strategy_lanes_latest", {}) or {},
                "institutional": self.us_db.get_state("institutional_13f_latest", {}) or {},
